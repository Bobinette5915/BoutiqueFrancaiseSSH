 ...
 */
final class Version20240124123123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carrier CHANGE description description VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carrier CHANGE description description TEXT NOT NULL');
    }
}
